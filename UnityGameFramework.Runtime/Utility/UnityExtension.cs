...
public static class UnityExtension
{
    ...
    public static void SetPositionX(this Transform t, float newValue)
    {
    ...
    public static void SetPositionY(this Transform t, float newValue)
    {
        Vector3 v = t.position;
        v.y = newValue;
        t.position = v;
    ...
    public static void SetPositionZ(this Transform t, float newValue)
    {
        Vector3 v = t.position;
        v.z = newValue;
        t.position = v;
    ...
    public static void AddPositionX(this Transform t, float deltaValue)
    {
        Vector3 v = t.position;
        v.x += deltaValue;
        t.position = v;
    ...
    public static void AddPositionY(this Transform t, float deltaValue)
    {
        Vector3 v = t.position;
        v.y += deltaValue;
        t.position = v;
    ...
    public static void AddPositionZ(this Transform t, float deltaValue)
    {
        Vector3 v = t.position;
        v.z += deltaValue;
        t.position = v;
    ...
    /// <param name="t"><see cref="UnityEngine.Transform" /> 对象。</param>
    /// <param name="newValue">x 坐标值。</param>
    public static void SetLocalPositionX(this Transform t, float newValue)
    {
    ...
    /// <param name="t"><see cref="UnityEngine.Transform" /> 对象。</param>
    /// <param name="newValue">y 坐标值。</param>
    public static void SetLocalPositionY(this Transform t, float newValue)
    {
        Vector3 v = t.localPosition;
        v.y = newValue;
        t.localPosition = v;
    ...
    /// <param name="t"><see cref="UnityEngine.Transform" /> 对象。</param>
    /// <param name="newValue">z 坐标值。</param>
    public static void SetLocalPositionZ(this Transform t, float newValue)
    {
        Vector3 v = t.localPosition;
        v.z = newValue;
        t.localPosition = v;
    ...
    public static void AddLocalPositionX(this Transform t, float deltaValue)
    {
        Vector3 v = t.localPosition;
        v.x += deltaValue;
        t.localPosition = v;
    ...
    public static void AddLocalPositionY(this Transform t, float deltaValue)
    {
        Vector3 v = t.localPosition;
        v.y += deltaValue;
        t.localPosition = v;
    ...
    public static void AddLocalPositionZ(this Transform t, float deltaValue)
    {
        Vector3 v = t.localPosition;
        v.z += deltaValue;
        t.localPosition = v;
    ...
    public static void AddLocalScaleX(this Transform t, float deltaValue)
    {
        Vector3 v = t.localScale;
        v.x += deltaValue;
        t.localScale = v;
    ...
    public static void AddLocalScaleY(this Transform t, float deltaValue)
    {
        Vector3 v = t.localScale;
        v.y += deltaValue;
        t.localScale = v;
    ...
    public static void AddLocalScaleZ(this Transform t, float deltaValue)
    {
        Vector3 v = t.localScale;
        v.z += deltaValue;
        t.localScale = v;
